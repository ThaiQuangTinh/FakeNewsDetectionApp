...
def train_model():
    data = pd.read_csv('./BackEnd/Dataset/SocialContext/data.csv')
    ...
    # Khởi tạo và huấn luyện mô hình Support Vector Machine
...
def save_model(model, vectorizer, accuracy):
    ...
    joblib.dump(model, './BackEnd/Models/SocialContext/SVM/svm_model.pkl')
    joblib.dump(vectorizer, './BackEnd/Models/SocialContext/SVM/svm_vectorizer.pkl')
